import svgPaths from "./svg-v0jq64suko";
...
function Component2023Hover() {
  return (
    <div className="box-border content-stretch flex gap-[10px] items-center justify-end pb-[8px] pt-0 px-0 relative shrink-0 w-full" data-name="2023_hover">
...
function Year() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="year">
      <Frame13 />
    </div>
  );
}
...
function Component9() {
  return (
    <div className="box-border content-stretch flex items-center justify-center mr-[-40px] pl-0 pr-[48px] py-0 relative shrink-0" data-name="승객앱01">
...
function Component10() {
  return (
    <div className="box-border content-stretch flex gap-[48px] items-start justify-center mr-[-40px] pb-0 pt-[24px] px-0 relative shrink-0" data-name="승객앱02">
...
function Component() {
  return (
    <div className="relative shrink-0 w-full" data-name="승객앱">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-center flex flex-wrap gap-[48px] items-center justify-center pl-[288px] pr-[328px] py-[210px] relative w-full">
...
function BgImg() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-full" data-name="bg_img02">
...
function Component16() {
  return (
    <div className="bg-[#f6f2ff] box-border content-stretch flex gap-[10px] items-center justify-center px-[20px] py-0 relative rounded-[8px] shrink-0 size-[120px]" data-name="100">
...
function Component17() {
  return (
    <div className="bg-[#eae0fe] box-border content-stretch flex gap-[10px] items-center justify-center px-[20px] py-0 relative rounded-[8px] shrink-0 size-[120px]" data-name="150">
      <div className="flex flex-col font-['Pretendard:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#0d0d0d] text-[16px] text-center text-nowrap">
...
function Component18() {
  return (
    <div className="bg-[#c6acfd] box-border content-stretch flex gap-[10px] items-center justify-center px-[20px] py-0 relative rounded-[8px] shrink-0 size-[120px]" data-name="200">
      <div className="flex flex-col font-['Pretendard:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#0d0d0d] text-[16px] text-center text-nowrap">
...
function Component19() {
  return (
    <div className="bg-[#a982fc] box-border content-stretch flex gap-[10px] items-center justify-center px-[20px] py-0 relative rounded-[8px] shrink-0 size-[120px]" data-name="300">
      <div className="flex flex-col font-['Pretendard:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#0d0d0d] text-[16px] text-center text-nowrap">
...
function Component20() {
  return (
    <div className="bg-[#8d59fb] box-border content-stretch flex gap-[10px] items-center justify-center px-[20px] py-0 relative rounded-[8px] shrink-0 size-[120px]" data-name="400">
...
function Component21() {
  return (
    <div className="bg-[#702ffa] box-border content-stretch flex gap-[10px] items-center justify-center px-[20px] py-0 relative rounded-[8px] shrink-0 size-[120px]" data-name="500">
      <div className="flex flex-col font-['Pretendard:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-center text-nowrap text-white">
...
function Component22() {
  return (
    <div className="bg-[#5a26c8] box-border content-stretch flex gap-[10px] items-center justify-center px-[20px] py-0 relative rounded-[8px] shrink-0 size-[120px]" data-name="600">
      <div className="flex flex-col font-['Pretendard:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-center text-nowrap text-white">
...
function Component23() {
  return (
    <div className="bg-[#431c96] box-border content-stretch flex gap-[10px] items-center justify-center px-[20px] py-0 relative rounded-[8px] shrink-0 size-[120px]" data-name="700">
      <div className="flex flex-col font-['Pretendard:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-center text-nowrap text-white">
...
function Component24() {
  return (
    <div className="bg-[#2d1364] box-border content-stretch flex gap-[10px] items-center justify-center px-[20px] py-0 relative rounded-[8px] shrink-0 size-[120px]" data-name="800">
      <div className="flex flex-col font-['Pretendard:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-center text-nowrap text-white">
...
function Component25() {
  return (
    <div className="bg-[#160932] box-border content-stretch flex gap-[10px] items-center justify-center px-[20px] py-0 relative rounded-[8px] shrink-0 size-[120px]" data-name="900">
      <div className="flex flex-col font-['Pretendard:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-center text-nowrap text-white">
...
function Konai1() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="konai_02">
      <div className="flex flex-col items-end size-full">
        <div className="box-border content-stretch flex flex-col gap-[210px] items-end px-[40px] py-[280px] relative w-full">
          <Color />
...
function Frame5() {
  return (
    <div className="bg-[#0d0d0d] h-[80px] relative rounded-[30px] shrink-0 w-full">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[10px] h-[80px] items-center justify-center p-[16px] relative w-full">
          <Component1 />
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-[#0d0d0d] h-[80px] relative rounded-[30px] shrink-0 w-full">
      <div className="flex flex-col items-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[10px] h-[80px] items-center px-[15px] py-[16px] relative w-full">
          <Car />
        </div>
      </div>
    </div>
...
function Frame11() {
  return (
    <div className="bg-[#0d0d0d] box-border content-stretch flex flex-col gap-[10px] items-start p-[16px] relative rounded-[30px] shrink-0 size-[80px]">
      <Group1 />
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="bg-[#0d0d0d] box-border content-stretch flex gap-[10px] items-center p-[16px] relative rounded-[30px] shrink-0 size-[80px]">
      <Group4 />
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="basis-0 grow h-[80px] min-h-px min-w-px relative shrink-0">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[10px] h-[80px] items-start p-[16px] relative w-full">
          <Group2 />
          <Group8 />
        </div>
      </div>
...
function Frame8() {
  return (
    <div className="[grid-area:1_/_1] bg-[#0d0d0d] box-border content-stretch flex gap-[10px] items-center ml-0 mt-0 p-[16px] relative rounded-[30px] size-[80px]">
      <Group />
    </div>
  );
}
...
function Like() {
  return (
    <div className="content-stretch flex gap-[10px] h-[134px] items-start justify-center relative shrink-0" data-name="like">
      <Frame2 />
    </div>
  );
}
...
function ColorChart() {
  return (
    <div className="opacity-80 relative shrink-0 w-full" data-name="color chart">
      <div className="size-full">
        <div className="box-border content-start flex flex-wrap gap-[80px] items-start pl-[50px] pr-[120px] py-[60px] relative w-full">
          <Component2 />
          <Component4 />
          <Component5 />
          <Component6 />
  ...
  return (
    <div className="basis-0 bg-[#f9f9f9] grow min-h-px min-w-px relative self-stretch shrink-0" data-name="text">
      <div className="flex flex-row items-end size-full">
        <div className="box-border content-stretch flex gap-[10px] items-end pb-[40px] pt-0 px-[40px] relative size-full">
...
function Konai2() {
  return (
    <div className="bg-white box-border content-stretch flex gap-[40px] items-start px-[40px] py-0 relative shrink-0 w-[1920px]" data-name="konai_03">
      <Iocn />
      <Text1 />
    </div>
  );
...
function AppImg() {
  return (
    <div className="box-border content-stretch flex items-start justify-center pl-0 pr-[48px] py-0 relative shrink-0 w-full" data-name="app_img">
...
function Taxi() {
  return (
    <div className="bg-[#f6f2ff] box-border content-stretch flex flex-col gap-[48px] items-center px-0 py-[210px] relative shrink-0 w-full" data-name="taxi">
...
function Konai3() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="konai_04">
      <div className="flex flex-col items-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[24px] items-center pb-[280px] pt-[40px] px-[40px] relative w-full">
          <Taxi />

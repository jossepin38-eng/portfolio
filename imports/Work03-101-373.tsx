import svgPaths from "./svg-oa1ayq0t7z";
...
function UserApp1() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[312px] pl-0 pr-[48px] py-0 top-[315px]" data-name="user_app02">
...
function UserApp() {
  return (
    <div className="absolute content-stretch flex gap-[48px] items-start justify-center left-[462px] pb-0 pt-[24px] px-0 top-[916px]" data-name="user_app01">
...
function BgImg() {
  return (
    <div className="h-[1856px] relative shrink-0 w-full" data-name="bg_img02">
      ...
      <p className="absolute font-['Pretendard:Bold',sans-serif] leading-[normal] left-[344.5px] not-italic text-[48px] text-white top-[210px] w-[1231px]">동백택시 - 승객앱</p>
      <UserApp1 />
      <UserApp />
    </div>
  );
...
function Component9() {
  return (
    <div className="bg-[#0d0d0d] h-[80px] relative rounded-[30px] shrink-0 w-full" data-name="01">
...
function Component10() {
  return (
    <div className="bg-[#0d0d0d] h-[80px] relative rounded-[30px] shrink-0 w-full" data-name="02">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex h-[80px] items-center justify-center p-[16px] relative w-full">
          <Component2 />
        </div>
...
function Component11() {
  return (
    <div className="bg-[#0d0d0d] h-[80px] relative rounded-[30px] shrink-0 w-full" data-name="03">
...
function Component12() {
  return (
    <div className="bg-[#0d0d0d] content-stretch flex flex-col items-start p-[16px] relative rounded-[30px] shrink-0 size-[80px]" data-name="04">
      <Group1 />
    </div>
  );
}
...
function Component13() {
  return (
    <div className="bg-[#0d0d0d] content-stretch flex items-center p-[16px] relative rounded-[30px] shrink-0 size-[80px]" data-name="05">
      <Group3 />
    </div>
  );
}
...
function Component14() {
  return (
    <div className="bg-[#0d0d0d] content-stretch flex items-center p-[16px] relative rounded-[30px] shrink-0 size-[80px]" data-name="06">
      <Component7 />
    </div>
  );
}
...
function Component15() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="07">
      <Frame1 />
    </div>
  );
}
...
function Iocn() {
  return (
    <div className="basis-0 bg-[#702ffa] grow min-h-px min-w-px relative shrink-0" data-name="iocn">
      <div className="size-full">
        <div className="content-stretch flex flex-col gap-[60px] items-start pb-[210px] pt-[48px] px-[40px] relative w-full">

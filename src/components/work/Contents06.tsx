...
function Img1() {
  return (
    <div className="absolute h-[1739.5px] left-0 top-[1739.5px] w-[1473px]" data-name="img02">
      <div className="relative size-full" data-name="hyun_img02">
...
function SubImg() {
  return (
    <div className="absolute h-[832px] left-1/2 -translate-x-1/2 rounded-[40px] top-[180px] w-[1280px]" data-name="sub_img">
...
export default function Contents06() {
  return (

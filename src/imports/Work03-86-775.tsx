import svgPaths from "./svg-78ljsqopmx";
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="승객앱">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-center flex flex-wrap gap-[48px] items-center justify-center pl-[288px] pr-[328px] py-[210px] relative w-full">

...
function MpopText() {
  return (
    <div className="relative shrink-0 w-full" data-name="mpop_text">
      <div className="flex flex-row justify-end size-full">
        <div className="content-stretch flex items-start justify-end pl-0 pr-[40px] py-0 relative w-full">
          <p className="font-['Inter:Bold',sans-serif] font-bold leading-none not-italic relative shrink-0 text-[160px] text-[rgba(0,0,0,0.2)] text-right tracking-[-6.4px] w-[960px]">mPOP</p>
        </div>
      </div>
    </div>
  );
...
function BgArea() {
  return (
    <div className="content-stretch flex h-[1037px] items-center relative shrink-0 w-[1920px]" data-name="bg_area">
      <BgWhite />
      <BgBlue />
    </div>
  );
...
function Bg() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="bg">
      <BgArea />
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="text">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pb-0 pl-[960px] pr-0 pt-[40px] relative w-full">
...
export default function Mpop() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start px-0 py-[180px] relative size-full" data-name="mpop02">
      <MpopText />
      <Bg />
      <Text />
      <Calculator />

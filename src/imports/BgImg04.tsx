...
import imgBgImg04 from "figma:asset/ec664e27896887c7e016f0f0c8c3193f61241632.png";
...
export default function BgImg() {
  return (
    <div className="content-stretch flex flex-col items-center px-0 py-[210px] relative size-full" data-name="bg_img04">
